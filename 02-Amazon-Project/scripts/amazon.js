const products = [
  {
    ...
    // calculations using floats can be inaccurate in JavaScript
    // when calculating money, do it in cents instead of dollars, then convert back to dollars
    priceCents: 1090, //10.90 dollars
  },
  {
